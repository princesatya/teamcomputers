...
const AccessoriesSection = () => {
    ...
    return (
        <div className=" mobile-carousel-team-computer">
                ...
                <div className="container-fluid d-none d-lg-block d-md-block">
                    <div className="row">
                        ...
                        <div className="col-md-9">
                            <div className="row">
                                {accessories && accessories.filter((a, i) => i < 5).map((accessory, index) =>
                                // {index < 5 && (
                                    <div className="col-md-4" key={index}>
                                        <AccessoriesSectionCard id={accessory.sku} PrductImg={accessory.image.url} ProductDetail={accessory.name} ProductPrice={getSampleCurrencyFormat(accessory.price_range.minimum_price.regular_price.currency, accessory.price_range.minimum_price.regular_price.value)} />
                                    </div>
                                )}
                                {/* )} */}
